...
const Chatbar = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className="flex w-full gap-3 items-center justify-center cursor-pointer select-none rounded-md border border-white/20 p-4 mt-4 text-[14px] leading-normal text-white transition-colors duration-200 hover:bg-gray-500/10"
        onClick={() => handleLearnBot()}
      >
        <svg
          width="41"
          height="41"
